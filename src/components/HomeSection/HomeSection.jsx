  ...
  return (
    <StyledHomeSection ref={homeRef}>
      <Card>
        ...
        <h1>Joe Gerhard</h1>
        <p>
        I'm a front end developer based in Austin, TX with a professional background in the music industry including lighting design, audio production, stage management, and tour management.
        </p>
